...
init shared url =
    ...
    , sendActions
        ...
        , """{"jsonrpc": "2.0", "method": "VideoLibrary.GetMusicVideos", "params": { "properties": [ "title", "thumbnail", "artist", "album", "genre", "lastplayed", "year", "runtime", "fanart", "file", "streamdetails","dateadded","director","studio"] }, "id": "libMusicVideos"}"""
        ]
    )
