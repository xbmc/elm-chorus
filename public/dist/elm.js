...
var $author$project$Global$sendMessage = _Platform_outgoingPort('sendMessage', $elm$json$Json$Encode$string);
...
var $author$project$Global$update = F2(
	function (msg, model) {
		if (msg.$ === 'Navigate') {
			...
			return _Utils_Tuple2(
				model,
				$author$project$Global$sendMessage('{ "jsonrpc": "2.0", "method": "Input.ExecuteAction", "params": { "action": "playpause" }, "id": 1 }'));
		}
	});
...
var $author$project$Document$toBrowserDocument = function (doc) {
	return {
		body: _List_fromArray(
			[
				A2(
...
var $author$project$Global$PlayPause = {$: 'PlayPause'};
...
var $author$project$Components$controlButton = A2(
	...
	_List_Nil,
	{
		label: $mdgriffith$elm_ui$Element$html(
			A2(
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$color('lightgrey')
					]),
				A2($feathericons$elm_feather$FeatherIcons$withSize, 36, $feathericons$elm_feather$FeatherIcons$moreVertical))),
...
var $author$project$Components$playButton = function (_v0) {
		...
		_List_Nil,
		{
			label: $mdgriffith$elm_ui$Element$html(
				A2(
					...
					A2($feathericons$elm_feather$FeatherIcons$withSize, 48, $feathericons$elm_feather$FeatherIcons$play))),
...
var $author$project$Components$repeatButton = A2(
	$mdgriffith$elm_ui$Element$Input$button,
	_List_Nil,
	{
		label: $mdgriffith$elm_ui$Element$html(
			A2(
				...
				A2($feathericons$elm_feather$FeatherIcons$withSize, 36, $feathericons$elm_feather$FeatherIcons$repeat))),
		onPress: $elm$core$Maybe$Nothing
	});
...
var $author$project$Components$reverseButton = A2(
	$mdgriffith$elm_ui$Element$Input$button,
	_List_Nil,
	{
		label: $mdgriffith$elm_ui$Element$html(
			A2(
				...
				A2($feathericons$elm_feather$FeatherIcons$withSize, 36, $feathericons$elm_feather$FeatherIcons$skipBack))),
		onPress: $elm$core$Maybe$Nothing
	});
...
var $author$project$Components$shuffleButton = A2(
	$mdgriffith$elm_ui$Element$Input$button,
	_List_Nil,
	{
		label: $mdgriffith$elm_ui$Element$html(
			A2(
				...
				A2($feathericons$elm_feather$FeatherIcons$withSize, 36, $feathericons$elm_feather$FeatherIcons$shuffle))),
		onPress: $elm$core$Maybe$Nothing
	});
...
var $author$project$Components$skipButton = A2(
	$mdgriffith$elm_ui$Element$Input$button,
	_List_Nil,
	{
		label: $mdgriffith$elm_ui$Element$html(
			A2(
				...
				A2($feathericons$elm_feather$FeatherIcons$withSize, 36, $feathericons$elm_feather$FeatherIcons$skipForward))),
		onPress: $elm$core$Maybe$Nothing
	});
...
var $author$project$Components$volumeButton = A2(
	...
	_List_Nil,
	{
		label: $mdgriffith$elm_ui$Element$html(
			A2(
				...
				A2($feathericons$elm_feather$FeatherIcons$withSize, 36, $feathericons$elm_feather$FeatherIcons$volume2))),
		url: $author$project$Generated$Route$toHref($author$project$Generated$Route$Docs)
	});
var $author$project$Components$footer = function (_v0) {
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Components$reverseButton),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[$mdgriffith$elm_ui$Element$centerX]),
						$author$project$Components$playButton(
							{action: playPauseMsg})),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[$mdgriffith$elm_ui$Element$centerX]),
						$author$project$Components$skipButton)
					])),
				A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$el,
						_List_Nil,
						$mdgriffith$elm_ui$Element$text('Volume')),
						A2(
						$mdgriffith$elm_ui$Element$row,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[$mdgriffith$elm_ui$Element$centerX]),
								$author$project$Components$volumeButton),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[$mdgriffith$elm_ui$Element$centerX]),
								$author$project$Components$repeatButton),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[$mdgriffith$elm_ui$Element$centerX]),
								$author$project$Components$shuffleButton),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[$mdgriffith$elm_ui$Element$centerX]),
								$author$project$Components$controlButton)
							]))
					]))
			]));
};
var $author$project$Components$header = A2(
	$mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
		...
		[
			...
			_List_Nil,
			{
				label: A2(
					...
					{description: '', src: 'https://kodi.wiki/images/8/8e/Thumbnail-symbol-transparent.png'}),
				url: $author$project$Generated$Route$toHref($author$project$Generated$Route$Top)
			}),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
...
var $author$project$Components$helpButton = A2(
	$mdgriffith$elm_ui$Element$Input$button,
	_List_Nil,
	{
		label: $mdgriffith$elm_ui$Element$html(
...
var $author$project$Components$playlistButton = A2(
	$mdgriffith$elm_ui$Element$Input$button,
	_List_Nil,
	{
		label: $mdgriffith$elm_ui$Element$html(
			A2(
				$feathericons$elm_feather$FeatherIcons$toHtml,
				_List_Nil,
				A2($feathericons$elm_feather$FeatherIcons$withSize, 24, $feathericons$elm_feather$FeatherIcons$clipboard))),
		onPress: $elm$core$Maybe$Nothing
	});
...
var $author$project$Components$settingsButton = A2(
	$mdgriffith$elm_ui$Element$Input$button,
	_List_Nil,
	{
		label: $mdgriffith$elm_ui$Element$html(
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Components$header,
						A2(
						$mdgriffith$elm_ui$Element$row,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								...
								$author$project$Components$leftSidebar),
								A2(
								$mdgriffith$elm_ui$Element$column,
								_List_fromArray(
									[
						...
						_List_Nil,
						{
							label: $mdgriffith$elm_ui$Element$html(
								A2(
									...
									A2($feathericons$elm_feather$FeatherIcons$withSize, 48, $feathericons$elm_feather$FeatherIcons$play))),
							onPress: $elm$core$Maybe$Just(playPauseMsg)
						}),
...
var $author$project$Global$view = function (_v0) {
	...
	return $author$project$Components$layout(
		{
			page: page,
			playPauseMsg: toMsg($author$project$Global$PlayPause)
		});
};
var $author$project$Main$view = function (model) {
	return $author$project$Document$toBrowserDocument(
		$author$project$Global$view(
			{
				global: model.global,
				page: A2(
